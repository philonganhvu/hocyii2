            ...
            <div class="container clearfix">
                ...
                <div id="primary-menu">
                    ...
                    if (Yii::$app->user->isGuest) {
                        $menuItems[] = ['label' => 'Karaoke', 'url' => ['/showkara/index']];
                        $menuItems[] = ['label' => 'Signup', 'url' => ['/site/signup']];
                        $menuItems[] = ['label' => 'Login', 'url' => ['/site/login']];
                    } else {
                        $menuItems[] = ['label' => 'Karaoke', 'url' => ['#'],
                            'items' => [
                                ['label' => 'Show Karaoke', 'url' => ['/showkara/index']],
                                ['label' => 'Youtube Karaoke', 'url' => ['/youtube/index']],
                                ['label' => 'List Karaoke', 'url' => ['/karaoke/index']],
                            ],
                        ];
                        $menuItems[] = ['label' => 'Giải Trí', 'url'=> ['sing/index']];
                        $menuItems[] = ['label' => 'Giọng Ca Mới', 'url'=> ['sing/index']];
                        $menuItems[] = [
                ...
                <div class="col_two_third">
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="widget clearfix">
                            ...
                            <img src="<?=Yii::$app->homeUrl?>/images/footer-widget-logo.png" alt="" class="footer-logo">

                            <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

                            <div style="background: url('<?=Yii::$app->homeUrl?>/images/world-map.png') no-repeat center center; background-size: 100%;">
                                <address>
