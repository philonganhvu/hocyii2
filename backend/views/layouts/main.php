                ...
                <div class="page-header">
                    ...
                    <div class="page-header-top">
                        <div class="container">
                            ...
                            <div class="page-logo">
                                <a href="index.html">
                                    <img src="<?=Yii::$app->homeUrl?>/common/layouts/layout/img/logo-default.jpg" alt="logo" class="logo-default">
                                </a>
                            </div>
                            <!-- END LOGO -->
                            <!--multi languages-->
                            <div class="pull-right selectpicker" id="language-selector" style="position:relative; top:27px" >
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="menu-dropdown classic-menu-dropdown active">
                                        ...
                                        <ul class="dropdown-menu pull-left">
                                            <li class=" active">
                                                <a href="<?=Yii::$app->homeUrl?>index.html" class="nav-link  active">
